...
def createNew(filename = "Report.docx"):
    ...
    head.add_run("INFINITEX LABS").font.underline = True
...
def ViewTab(textfile):
    ...
    for col in table.columns:
        col.height = Cm(1.2)
    doc.add_paragraph().add_run("Final Result:").font.bold = True
    if count == 0:
    ...
    return r"C:\Users\12118\Documents\hackthon_2022\lab\Reports\Report.docx"
doc = docx.Document()
createNew(r"C:\Users\12118\Documents\hackthon_2022\lab\Reports\Report.docx")
doc.save(ViewTab(r"C:\Users\12118\Documents\hackthon_2022\lab\Samples\Sample1.txt"))
docx2pdf.convert(r"C:\Users\12118\Documents\hackthon_2022\lab\Reports\Report.docx")
